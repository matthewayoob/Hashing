...
private:
    ...
    */
    ...
    /** Creates a HashFunction<string> variable to store the hash function*/
    HashFunction<std::string> hashFunc;
    /** Creates an integer variable for amount of spots*/
    int amtOfSpots;
    /** Creates an integer variable for amount of inserted spots */
    int insertedAmt;
    /** Creates an integer variable for amount of tombstones */
    int amtOfTombstones;
    /* Constant used to denote the tombstone threshhold.
     */
    static const int TOMBSTONE_AMT  = 15;
